...
export function HomeScreen() {
  ...
  const prefix = category === 'chinese' ? 'zh' : category === 'korean' ? 'ko' : category === 'japanese' ? 'jp' : category === 'spanish' ? 'es' : category === 'french' ? 'fr' : category === 'german' ? 'de' : category === 'portuguese' ? 'pt' : category === 'russian' ? 'ru' : category === 'polish' ? 'pl' : category === 'hindi' ? 'hi' : category === 'arabic' ? 'ar' : category === 'tagalog' ? 'tl' : 'en'
