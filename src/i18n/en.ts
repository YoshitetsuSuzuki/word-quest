...
export const en: Strings = {
  ...
  'home.language': 'Language', 'home.pin': 'Pin to home', 'home.pinned': 'Pinned', 'home.comingSoon': 'Soon', 'home.level': 'Level', 'home.mixed': 'Mixed',
  ...
  // Comeback notifications (voiced by the buddy). %s = buddy name, %d = words learned
  'comeback.t.d3': '%s is waiting', 'comeback.b.d3': "It's been 3 days! Fancy a quick round together?",
  'comeback.t.d7': '%s is getting restless', 'comeback.b.d7': 'A week already. Five minutes is plenty.',
  'comeback.t.d14': '%s keeps looking out the window', 'comeback.b.d14': 'Two weeks. Still here. Just one question?',
  'comeback.t.m1': '%s is flipping through the album', 'comeback.b.m1': "A month. Your %d words are all still here.",
  'comeback.t.m2': '%s is getting sleepy', 'comeback.b.m2': "Two months. Let's start stacking again.",
  'comeback.t.m3': '%s is tidying up your desk', 'comeback.b.m3': 'Three months. Ready whenever you are.',
