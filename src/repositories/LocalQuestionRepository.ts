...
const WORDBANK_CATEGORIES = new Set<Category>(['english', 'chinese', 'korean', 'japanese', 'spanish', 'french', 'german', 'portuguese', 'russian', 'polish', 'hindi', 'arabic', 'tagalog', 'italian', 'mongolian'])
