...
export const categories: CategoryInfo[] = [
  ...
  { id: 'spanish', label: 'スペイン語', emoji: '🇪🇸', available: false, availableLocales: ['en'] },
  { id: 'french', label: 'フランス語', emoji: '🇫🇷', available: false, availableLocales: ['en'] },
  { id: 'german', label: 'ドイツ語', emoji: '🇩🇪', available: false, availableLocales: ['en'] },
]
